...
function App() { //state to store establishments data
  ...
  return (
    <div className="App">
      ...
      <h1 className={location.pathname === '/' ? 'home-heading' : ''}>SHELTER MEAL</h1>
      <Navbar/>
      <Routes>
        <Route path= "/" element = {<Home />} />
        <Route path="/UES" element={<UES />} />
        <Route path="/UWS" element={<UWS />} />
        <Route path= "/restaurants" element = {<Restaurants establishment={establishment} />} /> 
